...
public class FragmentHome extends Fragment implements ChatAdapter.ViewHolder.ClickListener {
    ...
    public List<Chat> setData(){
        ...
        @DrawableRes int img[]= {R.drawable.user2 , R.drawable.user1, R.drawable.user1, R.drawable.user1, R.drawable.user1 , R.drawable.user1 , R.drawable.user1, R.drawable.user1, R.drawable.user1, R.drawable.user1 };
        ...
        for (int i = 0; i< conversation.size(); i+= 2){
            ...
            chat.setName(String.valueOf(img[i]));
            chat.setImage(img[i]);
    ...
    public void onItemClicked (int position) {
        // passar informação sobre conversa
            ...
            String UserPic = ((TextView) mRecyclerView.findViewHolderForAdapterPosition(position).itemView.findViewById(R.id.tv_user_name)).getText().toString();
            ...
            intent.putExtra("UserPic", myLocation);  // pass your values and retrieve them in the other Activity using keyName
