...
public class VideoChatViewActivity extends AppCompatActivity {
    ...
    private void setupVideoProfile() {
        ...
        VideoEncoderConfiguration videoEncoderConfiguration = new VideoEncoderConfiguration(VideoEncoderConfiguration.VD_640x360, VideoEncoderConfiguration.FRAME_RATE.FRAME_RATE_FPS_15,
    ...
    private void joinChannel() {
        mRtcEngine.joinChannel(null, "dwbu23rfrefw", "Extra Optional Data", 0);
    }
